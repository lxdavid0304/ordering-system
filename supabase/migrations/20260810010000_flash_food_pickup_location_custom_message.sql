-- Allow an optional administrator message to travel with a location's pickup notice.
create function public.admin_queue_flash_food_pickup_location_notification(
  p_campaign_id uuid,
...
grant execute on function public.admin_queue_flash_food_pickup_location_notification(uuid, text, timestamptz, text) to authenticated;
